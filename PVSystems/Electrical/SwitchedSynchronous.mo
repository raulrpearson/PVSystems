...
model SwitchedSynchronous "Switch network implemented with switched components"
...
equation
  ...
  connect(n1, sw1.n) annotation (Line(points={{-100,-50},{-80,-50},{-80,-10}},
        color={0,0,255}));
  connect(signalPWM.vc, d)
    annotation (Line(points={{0,-82},{0,-120}}, color={0,0,127}));
  connect(sw2.p, p2) annotation (Line(points={{80,10},{80,10},{80,50},{100,50}},
        color={0,0,255}));
  connect(sw2.n, n2) annotation (Line(points={{80,-10},{80,-10},{80,-50},{100,
          -50}}, color={0,0,255}));
  ...
  connect(deadTime.c1, sw1.control) annotation (Line(points={{-4,-19},{-4,-19},
          {-4,0},{-73,0}}, color={255,0,255}));
  connect(deadTime.c2, sw2.control) annotation (Line(points={{4,-19},{4,-19},{4,
          1.33227e-015},{73,1.33227e-015}}, color={255,0,255}));
